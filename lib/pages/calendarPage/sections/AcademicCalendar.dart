...
class AcademicCalendar extends StatefulWidget {
  final List<AcademicCalendarItem>? itemList;

  AcademicCalendar({Key? key, this.itemList}) : super(key: key);
                ...
                if (DateTime
                  ...
                  ...[
                    SizedBox(
                      height: 20,
                      child: ListTile(
                        leading: Text('${item.dateFrom} ~ ${item.dateTo}', style: const TextStyle(fontSize: 10), textAlign: TextAlign.center,),
                        title: Text('${item.title}',
                          overflow: TextOverflow.ellipsis,
                          style: const TextStyle(height: -0.3, fontSize: 10),
