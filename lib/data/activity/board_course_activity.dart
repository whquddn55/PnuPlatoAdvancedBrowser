...
class BoardCourseActivity extends CourseActivity {
  BoardCourseActivity({
  ...
  Future<void> open(final BuildContext context) async {
    await Navigator.push(context, MaterialPageRoute(builder: (context) => BoardPage(boardId: id, courseTitle: courseTitle, courseId: courseId)));
  }
}
